...
if __name__ == "__main__":
    ...
    while(Hisoka):
        print("\n# Recommendations using Manhattan Formula")
        ...
        print("\n# Recommendations using Euclidean Formula")
        ...
        print("## Recommendations for {}: ".format(Hisoka))
        printe(recommend, 0, 1)
        print("\n# Recommendations using Pearson Formula")
        ...
        print("## Recommendations for {}: ".format(Hisoka))
        printe(recommend, 0, 1)
        print("\n# Recommendations using Cosine Coefficient Formula")
